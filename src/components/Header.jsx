...
const Header = () => {
    return (
      <div className="flex flex-col w-screen relative">
        {/* Background Image */}
        <img className="w-screen absolute z-[-1]" src={Background} alt="background image" />

        {/* NavBar */}
        <div className="text-slate-100 flex items-center text-lg font-bold top-0 w-screen h-[80px] justify-between mb-[200px]">
        ...
        <div className="flex items-center flex-col">
          <p className="bg-orange-500 p-2 text-center w-[150px] text-sm text-slate-100 font-bold rounded-3xl mb-5">REAL ESTATE</p>
          <h1 className="text-slate-100 w-[50%] text-center text-6xl">Invest in Real Estate with Our Company</h1>
